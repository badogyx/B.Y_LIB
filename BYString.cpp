...
String& String::remove(int begin, int len)
{
    if( (0 <= begin) && (begin <= m_length) )
    {
        int n = begin;
        int m = begin + len;
...
String String::sub(int i, int len) const
{
    ...
    if( (0 <= i) && (i <= m_length) )
    {
        ...
        char* str = reinterpret_cast<char*>( malloc(len + i) );
...
char& String::operator [] (int i)
{
    ...
    {
        THROW_EXCEPTION(IndexOutOfBoundsException, "parameter i is invilad...");
    }
}
